...
echo epoch = 0
%concord% -iNZGD2000,NE,D -oNZTM_D,EN -P8 -N6 in\test15.in out\test15a.out >> out\test15.txt
echo epoch = 2000.0
%concord% -iNZGD2000,NE,D -oNZTM_D@2000.0,EN -P8 -N6 in\test15.in out\test15b.out >> out\test15.txt
echo epoch = 2010.0
%concord% -iNZGD2000D,NE,D -oNZTM_D@2010.0,EN -P8 -N6 in\test15.in out\test15c.out >> out\test15.txt
